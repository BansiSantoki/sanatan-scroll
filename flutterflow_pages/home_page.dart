// FlutterFlow Target Page: Home (Route: /home)
// Target FlutterFlow Project ID: sanatan-scroll-gxh7pn
// Production Quality Build — Zero Grey Boxes, Instant Fallbacks & Full UI Verification
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // ==========================================
              // 1. HEADER ROW (Namaste, User Name & Fire Streak Pill)
              // ==========================================
              Row(
                ...
                children: [
                  ...
                  // Streak Pill Widget with instant fallback
              ...
              // ==========================================
              // 2. DAILY WISDOM HERO CARD ("TODAY'S SCROLL")
              // ==========================================
              ...
              // ==========================================
              // 4. EXPLORE SCRIPTURES SECTION HEADER & CARDS
              // ==========================================
              Text(
                'EXPLORE SCRIPTURES',
                style: GoogleFonts.inter(
              ...
              _ScriptureCard(
                ...
                onTap: () {
                  Navigator.of(context).pushNamed('/sacred-text-detail', arguments: 'mahabharata');
                },
              ),
              const SizedBox(height: 28),
            ],

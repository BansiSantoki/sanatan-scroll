...
class MockSacredTexts {
  ...
  static const List<SacredTextModel> all = [
    SacredTextModel(
      ...
      description:
          'The Bhagavad Gita is a 700-verse Hindu scripture that is part of the epic Mahabharata. Set in a narrative framework of a dialogue between Pandava prince Arjuna and his guide Krishna, it presents a synthesis of Hindu ideas about dharma, theistic bhakti, and the yogic ideals of moksha.',
    ...
    SacredTextModel(
      ...
      description:
          'The Ramayana is one of the two major Sanskrit epics of ancient India. It narrates the life of Rama, a prince of Ayodhya, and his quest to rescue his wife Sita from the demon king Ravana.',
      category: 'Dharma',
      chapters: 7,
      verses: 24000,
      pages: 500,
      gradientIndex: 1,
      iconEmoji: '🏹',
      keyTeachings: ['Dharma', 'Devotion', 'Righteousness', 'Sacrifice'],
    ),
    SacredTextModel(
      id: 'mahabharata',
      title: 'Mahabharata',
      ...
      description:
          'The Mahabharata is one of the two major Sanskrit epics of ancient India. It contains philosophical and devotional material, and the Bhagavad Gita is embedded within it.',
      category: 'Dharma',
      chapters: 18,
      verses: 100000,
      pages: 1200,
      gradientIndex: 2,
      iconEmoji: '⚔️',
      keyTeachings: ['Duty', 'Justice', 'Family', 'War & Peace'],
    ),
    SacredTextModel(
      id: 'upanishads',
      title: 'Upanishads',
      subtitle: 'Wisdom of the Sages',
      description:
          'The Upanishads are late Vedic Sanskrit texts of religious teachings and ideas still revered in Hinduism. They are the foundation of Hindu philosophical thought.',
      category: 'Upanishads',
      chapters: 108,
      verses: 0,
      pages: 400,
      gradientIndex: 3,
      iconEmoji: '🕉️',
      keyTeachings: ['Brahman', 'Atman', 'Moksha', 'Self-Realization'],
    ),
    SacredTextModel(
      id: 'vedas',
      title: 'Vedas',
